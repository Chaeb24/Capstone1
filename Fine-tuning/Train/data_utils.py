...
class RESIDE_Dataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        basename = os.path.basename(img)          # 예: "4303_0.85.png"
        id = basename.split('_')[0]               # → "4303"
        clear_name = id + self.format             # → "4303.png"
...
pwd = os.getcwd()
print(pwd)
path = 'D:\Capstone-2025\FFA-Net\data'  # path to your 'data' folder
